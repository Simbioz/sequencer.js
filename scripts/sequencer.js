...
require("./extensions/core/do-extension").extend(Sequencer.prototype);
require("./extensions/core/do-wait-extension").extend(Sequencer.prototype);
require("./extensions/core/do-wait-for-handle-extension").extend(Sequencer.prototype);
require("./extensions/core/do-with-handle-extension").extend(Sequencer.prototype);
